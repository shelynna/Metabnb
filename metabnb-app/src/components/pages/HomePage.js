...
import partner1 from '../../assets/imgs/partner (3).png'
import partner2 from '../../assets/imgs/partner (3).png'
import partner3 from '../../assets/imgs/partner (3).png'
import GroupImage from '../../assets/imgs/group-image.png'
    ...
    return (
        <>
            ...
            <section className="mb-10 mt-16 bg-primary py-3">
                <section className="bg-primary">
                    <div className="flex justify-between items-center max-w-7xl m-auto px-5 lg:px-10 py-2">
                        <img src={partner1} alt="MBToken" className="object-contain w-24 md:w-auto h-auto" />
                        <img src={partner2} alt="Metamask" className="object-contain w-24 md:w-auto h-auto" />
                        <img src={partner3} alt="Opensea" className="object-contain w-24 md:w-auto h-auto" />
                    </div>
                </section>
            </section>
            ...
            <section className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4  gap-4 px-8 sm:px-12 md:px-10 lg:px- xl:px-24 max-w-screen-2xl">
                {homeData.map((item) => (
                    <div key={item?.id} className="border border-[#d7d7d7] rounded-lg p-3 text-xs">
                        <img src={item?.img} alt="" className="object-contain w-[500px] h-auto" />
                        <div className="flex justify-between mt-3">
                            <p>Desert King</p>
                            <p className="font-semibold">1MBTs per night</p>
                        </div>
                        <div className="flex justify-between mt-3 ">
                            <p>2345Km away</p>
